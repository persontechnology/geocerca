            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="departamento_id" id="departamento_id" class="form-control @error('departamento_id') is-invalid @enderror" required>
                                ...
                                @foreach ($departamentos as $departamento)
                                    <option value="{{ $departamento->id }}" {{ old('departamento_id',$direccion->departamento_id)==$departamento->id?'selected':'' }}>{{ $departamento->nombre }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <input id="nombre" type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" value="{{ old('nombre',$direccion->nombre) }}" required autofocus>
