...
<div class="navbar navbar-expand-lg navbar-dark bg-{{ $bgtema }} navbar-static">
		...
		<ul class="navbar-nav flex-row order-1 order-lg-2 flex-1 flex-lg-0 justify-content-end align-items-center">
				...
				<li class="nav-item nav-item-dropdown-lg dropdown dropdown-user h-100">
					<a href="#" class="navbar-nav-link navbar-nav-link-toggler dropdown-toggle d-inline-flex align-items-center h-100" data-toggle="dropdown">
						...
						@if (Storage::exists(Auth::user()->foto))
							<img src="{{ Storage::url(Auth::user()->foto) }}" class="rounded-pill mr-lg-2" height="34" alt="">
                        @else
							<img src="{{ asset('img/man.png') }}" class="rounded-pill mr-lg-2" height="34" alt="">
                        @endif
					...
					<div class="dropdown-menu dropdown-menu-right">
						<a href="{{ route('perfil') }}" class="dropdown-item"><i class="icon-user-plus"></i> Mi perfil</a>
			...
			@else
				<li class="nav-item">
					<a href="{{ route('login') }}" class="navbar-nav-link navbar-nav-link-toggler">
						<i class="icon-user-lock"></i> Acceder
					</a>
				</li>
			@endauth
		</ul>
