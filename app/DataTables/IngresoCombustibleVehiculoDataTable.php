...
class IngresoCombustibleVehiculoDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('action', function($vehiculo){
            return view('ingresoCombustible.actionVehiculo',['vehiculo'=>$vehiculo])->render();
     ...
     *
     * @param \App\Models\IngresoCombustibleVehiculo $model
    ...
    {
        return 'IngresoCombustibleVehiculo_' . date('YmdHis');
    }
}
