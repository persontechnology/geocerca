...
class IngresarKilometrajeDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('kilometraje',function($vehiculo){
            return $vehiculo->ultimoKilometraje();
        })
        ->addColumn('action', function($vehiculo){
            return view('ingresoKilometraje.actionVehiculo',['vehiculo'=>$vehiculo])->render();
        })->rawColumns(['action','foto',['kilometraje']]);
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\Usuarios/Guardia/IngresarKilometraje $model
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::computed('kilometraje')->title('Kilometraje')->searchable(false),
    ...
    {
        return 'Guardia_IngresarKilometraje_' . date('YmdHis');
    }
}
